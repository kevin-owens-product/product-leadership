...
// Copy pre-baked audio (if any) generated by tools/generate-audio-supertonic.js
...
if (fs.existsSync(audioSrcDir)) {
    ...
    if (audioCount > 0) {
        console.log(`✓ Copied: ${audioCount} pre-baked audio files`);
    }
} else {
    console.log('  (no pre-baked audio found — PWA will fall back to live TTS)');
}
