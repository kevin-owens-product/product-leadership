import { safeColor } from './security/sanitize.js?v=2.3.0%2B20260712T151836Z';
import { applyLiteralHighlight, includesQuery } from './search/transcript-search.js?v=2.3.0%2B20260712T151836Z';
import {
    STORAGE_KEY,
    ...
    loadListeningStats,
    saveListeningStats
} from './state/storage.js?v=2.3.0%2B20260712T151836Z';
import { buildBookmarksExport, buildProgressExport, downloadJSON } from './share-export/export.js?v=2.3.0%2B20260712T151836Z';
import { bindNavTabs } from './ui/tabs.js?v=2.3.0%2B20260712T151836Z';
import { registerServiceWorker } from './sw/register-sw.js?v=2.3.0%2B20260712T151836Z';
import { createPlaybackSessionController } from './playback/controller.js?v=2.3.0%2B20260712T151836Z';
import { createSpeechPlayers } from './playback/audio.js?v=2.3.0%2B20260712T151836Z';
import { parseChaptersFromContent, extractEpisodeDurationMinutes } from './playback/chapters.js?v=2.3.0%2B20260712T151836Z';
import {
    renderPodcastCard,
    renderEpisodeCard,
    ...
    renderChapterItem,
    renderBookmarkItem
} from './ui/render.js?v=2.3.0%2B20260712T151836Z';
import { createScrubber, bufferedEndFraction } from './ui/scrubber.js?v=2.3.0%2B20260712T151836Z';
import { createRepeatSkipper } from './ui/long-press.js?v=2.3.0%2B20260712T151836Z';
import { getShowSpeed, setShowSpeed, clampSpeed, SPEED_PREFS_KEY } from './state/speed-prefs.js?v=2.3.0%2B20260712T151836Z';
import { sleepFadeVolume, sleepRemainingSeconds } from './playback/sleep-timer.js?v=2.3.0%2B20260712T151836Z';
import { findNextUp } from './state/queue-next.js?v=2.3.0%2B20260712T151836Z';
...
const BUILD_VERSION = '2.3.0+20260712T151836Z';
(function() {
